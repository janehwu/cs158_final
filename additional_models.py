...
def main():
	...
	print "Dummy"
	dummy_results.append(performance_CI(base_clf, X_test, y_test, "auroc"))
	dummy_results.append(performance_CI(base_clf, X_test, y_test, "accuracy"))

	print "Linear SVN"
	rbf_results.append(performance_CI(linear_clf, X_test, y_test, "auroc"))
	rbf_results.append(performance_CI(linear_clf, X_test, y_test, "accuracy"))

	print "Random Forest"
	rf_results.append(performance_CI(trained_rf, X_test, y_test, "auroc"))
	rf_results.append(performance_CI(trained_rf, X_test, y_test, "accuracy"))

	print "now plotting"
	plot_results(["accuracy", "auroc"], ("Random Forest", "SVN"), dummy_results, rf_results, rbf_results)
